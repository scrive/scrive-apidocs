...
echo "$generated_message" > "$KONTRAKCJA_ROOT/cabal.project"
echo "packages: . Shake" >> "$KONTRAKCJA_ROOT/cabal.project"
cat "$KONTRAKCJA_ROOT/cabal.project.template" >> "$KONTRAKCJA_ROOT/cabal.project"
