...
class TestProperties
  ...
  def initialize
    ...
    if is_missing_url || is_missing_admin || is_missing_tester || is_missing_a_counterpart || is_missing_pdf then
      ...
      msg += " \"tester-fstname\": \"Alex\",\n"
      msg += " \"tester-sndname\": \"Allen\",\n"
      msg += " \"first-counterpart-password\": \"password12\",\n"
      msg += " \"first-counterpart-fstname\": \"Robin\",\n"
      msg += " \"first-counterpart-sndname\": \"Rodriguez\",\n"
      msg += " \"second-counterpart-password\": \"password12\",\n"
      msg += " \"second-counterpart-fstname\": \"Jordan\",\n"
      msg += " \"second-counterpart-sndname\": \"Jones\",\n"
      msg += " \"third-counterpart-password\": \"password12\",\n"
      msg += " \"third-counterpart-fstname\": \"Lee\",\n"
      msg += " \"third-counterpart-sndname\": \"Lopez\",\n"
      raise msg
    end
  end
end
