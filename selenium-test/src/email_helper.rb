...
EMAIL_TITLES = {"invitation to sign"=> {"en"=> "Document to e-sign: contract",
                                        ...
                                        "et"=> "Dokument e-allkirjastamiseks: contract",
                                        "lv"=> "Parakstāmais dokuments: contract",
                                        "lt"=> "El. parašu pasirašomas dokumentas: contract",
                                        "de"=> "Zum E-Signieren vorgelegtes Dokument: contract",
                                        "is"=> "Skjal til rafrænnar undirskriftar: contract",
                ...
                "activate account"=> {"en"=> "Please activate your account",
                                      ...
                                      "no"=> "Vennligst aktiver kontoen din",
                                      ...
                                      "pt"=> "Active a conta",
                                      "et"=> "Aktiveerige enda konto",
                                      "lv"=> "Lūdzu, aktivizējiet savu kontu",
                                      "lt"=> "Prašom suaktyvinti savo paskyrą",
                                      "de"=> "Bitte aktivieren Sie Ihr Konto",
                                      "is"=> "Vinsamlegast virkjaðu reikninginn þinn",
                ...
                "change username"=> {"en"=> "Change of username",
                                     ...
                                     "et"=> "Kasutajanime vahetus",
                                     "lv"=> "LIetotājvārda maiņa",
                                     "lt"=> "Pakeisti vartotojo vardą",
                                     "de"=> "Änderung des Benutzernamens",
                                     "is"=> "Breyting á notandanafni",
                ...
                "document was saved"=> {"en"=> "A document was saved in your e-archive",
                                        ...
                                        "et"=> "Dokument salvestati Teie e-arhiivi",
                                        "lv"=> "Dokuments tika saglabāts e-arhīvā",
                                        "lt"=> "Dokumentas įrašytas į Jūsų el. archyvą.",
                                        "de"=> "Ein Dokument wurde in Ihrem E-Archiv gespeichert",
                                        "is"=> "Skjal var vistað í rafræna skjalasafnið þitt",
