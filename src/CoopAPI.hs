...
type CoopAPIFunction a = APIFunction CoopAPIContext a

instance APIContext CoopAPIContext where
    body= wsbody
...
getDocument :: CoopAPIFunction Document
getDocument = do
  author <- user <$> ask  
...
sendFromTemplate :: CoopAPIFunction APIResponse
sendFromTemplate = do
  author <- user <$> ask
...
getTemplate :: CoopAPIFunction Document
getTemplate = do 
  author <- user <$> ask
...
sendNewDocument :: CoopAPIFunction APIResponse
sendNewDocument = do
  author <- user <$> ask
...
getFiles :: CoopAPIFunction [(BS.ByteString, BS.ByteString)]
getFiles = do
...
getSignatories :: CoopAPIFunction [SignatoryDetails]
getSignatories = do
