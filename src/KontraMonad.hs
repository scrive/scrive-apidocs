...
class (Applicative m, DBMonad m, FilterMonad Response m, HasRqData m, KontraMonad m, MonadIO m, MonadPlus m, ServerMonad m, TemplatesMonad m, WebMonad Response m) => Kontrakcja m
