...
instance Configuration AppConf where
  confDefault = AppConf {
    ...
    , brandedDomains     = [BrandedDomain "https://domain.scrive.com" "/img/logo.png" "#000000" "#000000" "#FFFFFF" "#FFFFFF" "#FFFFFF" "#DDDDDD" "#CCCCCCC" "#AAAAAA" "#53B688" "#FFFFFF" "#33B1DD" "#FFFFFF" "blue" "hsl(215,30%,60%)" "#666666" "#364963" "#7A94B8" "#C2000A" "Scrive SMS" "Scrive Email" "info@scrive.com"]
