...
test_removingCompanyAccountWorks = do
  ...
  companydocs1 <- dbQuery $ GetDocuments [DocumentsVisibleToUser (userid adminuser)] [] [] (0,maxBound)
  ...
  companydocs <- dbQuery $ GetDocuments [DocumentsVisibleToUser (userid adminuser)] [] [] (0,maxBound)
...
test_privateUserTakoverWorks = do
  ...
  docs <- dbQuery $ GetDocuments [DocumentsVisibleToUser (userid user)] [] [] (0,maxBound)
