...
usageMsg = unlines
  ...
  , "transifex push-lang user password lang       "
    ++ "-- Push local language to Transifex. "
    ++ "It will overwrite the external version. "
    ++ "'lang' must be 'en'."
  , "transifex diff-lang user password lang       "
    ++ "-- Show a diff between the external version and your local one. "
    ++ "'resource' is taken to be '*'."
  , "transifex diff-all user password             "
    ++ "-- Show a diff between the external version and your local one. "
    ++ "'resource' and 'language' are taken to be '*'."
  , "transifex merge-lang user password lang      "
    ++ "-- Merge the external version with your local one. "
    ++ "'resource' is taken to be '*'."
  , "transifex merge-all user password            "
    ++ "-- Merge the external version with your local one. "
    ++ "'resource' and 'language' are taken to be '*'."
  , ""
  , "Low-level commands:"
