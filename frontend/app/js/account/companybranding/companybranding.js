...
window.CompanyBrandingModel = Backbone.Model.extend({
    ...
    toJSON: function() {
      return ({
        ...
        companysignviewprimarycolour: this.signviewBranding().signviewprimarycolour().customised() ? this.signviewBranding().signviewprimarycolour().colour() : '',
        companysignviewprimarytextcolour: this.signviewBranding().signviewprimarytextcolour().customised() ? this.signviewBranding().signviewprimarytextcolour().colour() : '',
        companysignviewsecondarycolour: this.signviewBranding().signviewsecondarycolour().customised() ? this.signviewBranding().signviewsecondarycolour().colour() : '',
        companysignviewsecondarytextcolour: this.signviewBranding().signviewsecondarytextcolour().customised() ? this.signviewBranding().signviewsecondarytextcolour().colour() : '',
