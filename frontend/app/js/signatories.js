...
window.Signatory = Backbone.Model.extend({
    ...
    initialize: function(args) {
        ...
        _.bindAll(this, 'document', 'saveurl', 'signIndex', 'participantIndex', 'signatoryid', 'author', 'current', 'status', 'fields', 'emailField', 'mobileField', 'fstnameField', 'sndnameField', 'companyField', 'companynumberField', 'personalnumberField', 'email', 'mobile', 'fstname', 'sndname', 'personalnumber', 'company', 'companynumber', 'field', 'fieldsByType', 'readyFields', 'customFields', 'name', 'nameInDocument', 'smartname', 'nameForLists', 'nameOrEmail', 'nameOrEmailOrMobile', 'saved', 'signdate', 'rejecteddate', 'seendate', 'readdate', 'deliveredInvitation', 'undeliveredInvitation', 'undeliveredMailInvitation', 'undeliveredSMSInvitation', 'signorder', 'setSignOrder', 'signs', 'signsuccessredirect', 'rejectredirect', 'makeSignatory', 'makeViewer', 'hasSigned', 'attachments', 'removeAttachment', 'addAttachment', 'clearAttachments', 'reachedBySignorder', 'canSign', 'ableToSign', 'isViewer', 'isLastViewer', 'updateLastViewer', 'checkLastViewerChange', 'allAttachemntHaveFile', 'allFieldsReadyForSign', 'signatureReadyForSign', 'signatures', 'hasSignatureField', 'hasPlacedSignatures', 'anySignatureHasImageOrPlacement', 'standardAuthentication', 'elegAuthentication', 'smsPinAuthentication', 'emailDelivery', 'padDelivery', 'mobileDelivery', 'emailMobileDelivery', 'apiDelivery', 'noneDelivery', 'emailConfirmationDelivery', 'mobileConfirmationDelivery', 'emailMobileConfirmationDelivery', 'noneConfirmationDelivery', 'remind', 'giveForPadSigning', 'reject', 'padSigningURL', 'changeAuthentication', 'changeEmail', 'changePhone', 'remindMail', 'rejectMail', 'addNewField', 'addNewCustomField', 'newField', 'addField', 'deleteField', 'csv', 'csvHeader', 'hasCsvField', 'hasTextFieldWithName', 'isCsv', 'setCsv', 'inpadqueue', 'removed', 'hasUser', 'userid', 'draftData', 'delivery', 'confirmationdelivery', 'setDelivery', 'setConfirmationDelivery', 'desynchronizeDeliveryAndConfirmationDeliveryIfNeeded', 'synchConfirmationDelivery', 'synchDelivery', 'authentication', 'setAuthentication', 'authenticationFieldValue', 'hasProblems', 'role', 'ensureAllFields', 'ensurePersNr', 'needsPersonalNumber', 'ensureMobile', 'needsMobile', 'needsEmail', 'ensureEmail', 'bindBubble', 'bubbleSelf', 'triggerBubble', 'normalizeWithFirstCSVLine', 'dropFirstCSVLine');
