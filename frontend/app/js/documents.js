...
window.Document = Backbone.Model.extend({
    ...
    initialize: function(args) {
        ...
        _.bindAll(this, 'defaults', 'viewer', 'signed', 'documentid', 'signatories', 'signatoriesThatCanSignNow', 'signatoriesThatCanSignNowOnPad', 'setDefaultTitle', 'hasDefaultTitle', 'addExistingSignatory', 'authorSignsFirstMode', 'authorSignsLastMode', 'authorNotSignsMode', 'mainfile', 'authorattachments', 'removeattachment', 'signatoryattachments', 'hasAnyAttachments', 'ready', 'readOnlyView', 'lang', 'title', 'setTitle', 'daystosign', 'setDaystosign', 'daystoremind', 'setDaystoremind', 'showheader', 'setShowheader', 'showrejectoption', 'setShowrejectoption', 'showpdfdownload', 'setShowpdfdownload', 'showfooter', 'setShowfooter', 'setReferenceScreenshot', 'hasReferenceScreenshot', 'infotext', 'canberestarted', 'canbeprolonged', 'restart', 'prolong', 'setautoreminder', 'canbecanceled', 'cancel', 'cancelMail', 'canseeallattachments', 'setInvitationMessage', 'invitationmessage', 'inviteMail', 'setConfirmationMessage', 'confirmationmessage', 'confirmMail', 'takeFirstScreenshot', 'takeSigningScreenshot', 'takeScreenshot', 'fieldsForSigning', 'requestPin', 'checksign', 'sign', 'clone', 'makeReadyForSigning', 'save', 'afterSave', 'saved', 'setSaved', 'setAttachments', 'draftData', 'status', 'currentSignatory', 'otherSignatories', 'removeSignatory', 'currentViewerIsAuthor', 'currentViewerIsAuthorsCompanyAdmin', 'preparation', 'pending', 'timedout', 'canceled', 'rejected', 'closed', 'signingInProcess', 'timeouttime', 'autoremindtime', 'file', 'signorder', 'elegTBS', 'lastSignatoryLeft', 'isTemplate', 'makeTemplate', 'recall', 'author', 'authorCanSignFirst', 'authorIsOnlySignatory', 'allowsDD', 'isSigning', 'isReviewing', 'isSignedNotClosed', 'isSignedAndClosed', 'isUnavailableForSign', 'currentSignatoryCanSign', 'signatoriesWhoSign', 'maxPossibleSignOrder', 'fixSignorderAfterRemoving', 'checkLastViewerChange', 'needRecall', 'parse', 'markAsNotReady', 'hasProblems', 'hasDocumentProblems', 'hasAtLeastOneSignatory', 'hasSignatoryProblems', 'newCheckboxName', 'newSignatureName', 'removeTypeSetters', 'killAllPlacements', 'bindBubble', 'bubbleSelf', 'hasEleg', 'hasEmail', 'hasSMS', 'hasPad', 'hasEmailAndSMS', 'isCsv', 'csv', 'normalizeWithFirstCSVLine', 'dropFirstCSVLine');
        this.bindBubble();
    },
    viewer: function() {
