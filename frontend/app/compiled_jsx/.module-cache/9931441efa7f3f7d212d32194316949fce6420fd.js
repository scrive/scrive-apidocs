...
require(['common/language_service', 'Underscore', 'Backbone', 'React', 'dashboard/DashboardView', 'postsignview/main_views', 'postsignview/simple_documents_service', 'common/global_events', 'common/utilities_service',

	 ////'text!/scripts/translations/locale-sv.json', 

'legacy_code'], function(padddd, _, Backbone, React, DashboardView, MainViews, SimpleDocumentsService, GlobalEvents, trans) {
  console.log("asd");
  /**
