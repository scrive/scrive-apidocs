...
window.CredentialsView = Backbone.View.extend({
  ...
  render: function () {
    ...
    var credentiasCol1 = $("<div class='col-xs-2'/>");
    var credentiasCol2 = $("<div class='col-xs-2 '/>");
    var credentiasCol3 = $("<div class='col-xs-2 '/>");
    var credentiasCol4 = $("<div class='col-xs-2 '/>");
    var credentiasCol5 = $("<div class='col-xs-2 '/>");
    credentiasCol0
      .append("<p><b>Credentials obtained for</b><br/><span>"  + oauth.email()                + "</span></p>");
    credentiasCol1
      .append("<p><b>Client credentials id</b><br/><span>"     + oauth.consumer_key()         + "</span></p>");
    credentiasCol2
      .append("<p><b>Client credentials secret</b><br/><span>" + oauth.client_shared_secret() + "</span></p>");
    credentiasCol3
      .append("<p><b>Token credentials id</b><br/><span>"      + oauth.final_token()          + "</span></p>");
    credentiasCol4
      .append("<p><b>Token credentials secret</b><br/><span>"  + oauth.final_token_secret()   + "</span></p>");
    credentiasCol5
      .append("<p><b>Access level</b><br/><span>"              + oauth.priviliges()           + "</span></p>");
