...
describe("admin/paymentspanel", function () {
  ...
  it("should render the payments panel", function () {
    ...
    // We should have 12 checkboxes (one for each option)
    assert.equal(checkboxes.size(), 12);
  ...
  it("should render the payments panel for non-admin with disabled checkboxes", function () {
    ...
    // We should have 12 disabled checkboxes (one for each option)
    assert.equal(checkboxes.size(), 12);
  ...
  it("should render checked and unchecked checkboxes based on state", function () {
    ...
    assert.equal(checkedCheckboxes.size(), 10); // Two options where set to false
    ...
    assert.equal(changedCheckedCheckboxes.size(), 9);
