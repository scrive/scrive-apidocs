define(["jquery"], function ($) {
    ...
    // @note: The id of the injected form is rather random.
    ...
    var mountIframe = function () {
        ...
        if ($("#hubspot-redirect-iframe").length == 0) {
            $("body").append("<div id='hubspot-redirect'></div>")
                     .append("<iframe name='hubspot-redirect-iframe' id='hubspot-redirect-iframe'></iframe>");
            return true;
        }
    };
