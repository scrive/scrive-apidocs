define([
  ...
  '../js/fieldplacementview/fieldplacementglobal',
  '../js/fieldplacementview/draggeblefield',
  '../js/fieldplacementview/texttypesetteroptionsview',
  '../js/fieldplacementview/checkboxplacementplacedview',
  '../js/fieldplacementview/checkboxplacementview',
  '../js/fieldplacementview/checkboxtypesetterview',
  '../js/fieldplacementview/signatureplacementplacedview',
  '../js/fieldplacementview/signatureplacementviewfordrawing',
  '../js/fieldplacementview/signatureplacementview',
  '../js/fieldplacementview/signatureplacementviewwithoutplacement',
  '../js/fieldplacementview/signaturetypesetterview',
  '../js/fieldplacementview/textplacementplacedview',
  '../js/fieldplacementview/textplacementview',
  '../js/fieldplacementview/texttypesetterview',
  '../js/fileverifier',
  '../js/payments',
  '../js/archive/archive',
  '../js/admin/admin',
