define(["legacy_code", "Underscore", "Backbone", "React", "common/button", "common/infotextinput","signview/identify/norwegian/norwegianidentifymodel"],
  ...
  return React.createClass({
    ...
    validMobile: function () {
      var mobile = this.props.model.mobile();
        ...
        <span>
          <div style={{marginBottom: "30px"}}>
            <Button
              ...
              style={{textDecoration: model.isDesktopMode() && "underline"}}
              size="big"
