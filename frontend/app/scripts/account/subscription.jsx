  ...
  updateSubscriptionAsAdmin: function (nsd, callback) {
    ...
    var fromFeatureFlags = function (ff) {
      return ({
        ...
        can_use_verimi_qes_to_sign: ff.canUseVerimiQesToSign,
...
var FeatureFlag = exports.FeatureFlag = Backbone.Model.extend({
  defaults: {
    ...
    "can_use_verimi_qes_to_sign": true,
  ...
  canUseVerimiQesToSign: function () {
     return this.get("can_use_verimi_qes_to_sign");
  },
  ...
  firstAllowedAuthenticationToSign: function () {
    ...
    else if (this.canUseVerimiQesToSign())
      return "verimi_qes"
    else
      // Should not happen, just in case
      return "standard";
  ...
  parse: function (args) {
    return {
      ...
      can_use_verimi_qes_to_sign: args.can_use_verimi_qes_to_sign,
