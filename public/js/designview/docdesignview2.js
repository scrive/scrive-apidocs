...
var DesignViewView = Backbone.View.extend({
    ...
    designStep2: function() {
        ...
        this.documentStep = new DocumentStep({documentdesignview : this.model});
        box.html(this.documentStep.el());
        return box;
    },
    designStep3: function() {
        var document = this.model.document();;
        var box = $("<div class='signStepsBody advancedMode'/>");
        this.documentStep = new DocumentStep({documentdesignview : this.model});
        box.html(this.documentStep.el());
   ...
   render: function () {
       ...
       var designbody3 = this.designStep3();

        var fileel;
        if (document.mainfile()) {
          fileel = $("<div class='subcontainer'/>");
          fileel.append(this.extraFileOptions());
          fileel.append(KontraFile.init({file: document.mainfile(), addFields: true}).view.el);
        }
        else {
         fileel = $("<div class='subcontainer'/>");
        ...
        var fileel2;
        if (document.mainfile()) {
          fileel2 = $("<div class='subcontainer'/>");
          fileel2.append(this.extraFileOptions());
          fileel2.append(KontraFile.init({file: document.mainfile()}).view.el);
        }
        else {
         fileel2 = $("<div class='subcontainer'/>");
         fileel2.append(this.uploadFileOption());
        }
        ...
        this.tabs = new KontraTabs({
            ...
            tabs: [
                this.tab1 = new Tab({
                    name  : document.isTemplate() ? localization.step1template : 'Participants',
                    pagehash : "step1",
                    elems : _.flatten([
                              [designbody1],
                              [$(fileel)]
                ...
                this.tab2 = new Tab({
                    name  : document.isTemplate() ? localization.step2template : 'Document',
                    pagehash : "step2",
                    elems :  _.flatten([
                              [designbody2],
                              [$(fileel2)]
                ...
                this.tab3 = new Tab({
                    name  : document.isTemplate() ? localization.step3template : 'Process',
                    pagehash : "step3",
                    elems :  _.flatten([
                              [designbody3],
                              [$(fileel)]
