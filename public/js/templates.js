...
safeReady(function() {
    ...
    $("select.signatoryselector").live('change', function() {
        ...
        if (opt.text() !== localization.sigattachmessage) {
            //console.log(opt);
