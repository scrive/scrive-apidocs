...
import qualified Control.Monad.Trans.Except as E (ExceptT, runExceptT)
...
runAggregatorStep :: EventInfo -> AggregatorState -> (Either AggregatorResult Edge, AggregatorState)
