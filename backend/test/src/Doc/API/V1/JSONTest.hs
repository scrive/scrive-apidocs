...
testUpdateWithAllFeatures = do
  ...
  testJSONWith (inTestDir "json/api_v1/test_7_update_result_with_attachments.json") (rsBody resFinalDoc)
  return ()
...
testList = do
  ...
  testJSONWith (inTestDir "json/api_v1/test_8_list_of_documents_before_saving.json") (rsBody resList1)
  ...
  testJSONWith (inTestDir "json/api_v1/test_8_list_of_documents_after_saving.json") (rsBody resList2)
  ...
  testJSONWith (inTestDir "json/api_v1/test_8_list_of_documents_after_operations.json") (rsBody resList3)
