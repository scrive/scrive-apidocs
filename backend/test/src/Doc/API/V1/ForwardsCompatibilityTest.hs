...
apiV1ForwardsCompatibilityTests env = testGroup "apiV1ForwardsCompatibilityTests"
  [ testThat "Using API V1 doesn't make unexpected changes in a V2 document" env testApiV1DoesNotBreakApiV2 ]
