...
testNewCompanyFeatureFlagDefaults  = do
  ...
  where checkNewAccountFlags ff = do
          ...
          assertEqual "New company can't use dk authentication to view" False (ffCanUseDKAuthenticationToView ff)
          assertEqual "New company can't use dk authentication to sign" False (ffCanUseDKAuthenticationToSign ff)
          assertEqual "New company can't use fi authentication to view" False (ffCanUseFIAuthenticationToView ff)
          assertEqual "New company can't use no authentication to view" False (ffCanUseNOAuthenticationToView ff)
          assertEqual "New company can't use no authentication to sign" False (ffCanUseNOAuthenticationToSign ff)
          assertEqual "New company can't use se authentication to view" False (ffCanUseSEAuthenticationToView ff)
          assertEqual "New company can't use se authentication to sign" False (ffCanUseSEAuthenticationToSign ff)
          ...
          assertEqual "New company can't use verimi authentication to view" False (ffCanUseVerimiAuthenticationToView ff)
          assertEqual "New company can't use idin authentication to view" False (ffCanUseIDINAuthenticationToView ff)
