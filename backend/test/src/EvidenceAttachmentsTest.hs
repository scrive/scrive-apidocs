...
sealedFileHasEvidenceAttachmentsVersion1 = do
  attachments <- E.extract <$> BS.readFile (inTestDir "pdfs/sealed.pdf")
...
sealedFileHasEvidenceAttachmentsVersion2 = do
  attachments <- E.extract <$> BS.readFile (inTestDir "pdfs/sealed-2.pdf")
  assertEqual "mismatched evidence attachment names"
...
sealedFileHasEvidenceAttachmentsVersion3 = do
  attachments <- E.extract <$> BS.readFile (inTestDir "pdfs/sealed-3.pdf")
  assertEqual "mismatched evidence attachment names"
