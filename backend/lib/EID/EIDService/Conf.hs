...
data EIDServiceConf = EIDServiceConf
  ...
  , eidUseForNOSign :: Bool
  , eidUseForFIView :: Bool
  , eidUseForSESign :: Bool
...
unjsonEIDServiceConf =
  objectOf
    ...
    <*> fieldDef "useForNOSign"
                 False
                 eidUseForNOSign
                 "Use EIDService for Norwegian BankID for auth to sign"
    <*> fieldDef "useForFIView"
                 False
                 eidUseForFIView
                 "Use EIDService for Finnish Tupas/FTN for auth to view"
    <*> fieldDef "useForSESign"
                 False
                 eidUseForSESign
                 "Use EIDService for Swedish BankID for signing"
