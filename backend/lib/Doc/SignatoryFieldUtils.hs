...
fieldShouldBeFilledBySender (SignatoryPersonalNumberField f) =
  spnfShouldBeFilledBySender f
fieldShouldBeFilledBySender (SignatoryCompanyNumberField f) =
  scnfShouldBeFilledBySender f
