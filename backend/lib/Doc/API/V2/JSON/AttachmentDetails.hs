...
requiredFromAttachmentDetailsWithFileIDOrFileParam (AttachmentDetailsWithFileID _ r _ _) = r
requiredFromAttachmentDetailsWithFileIDOrFileParam (AttachmentDetailsWithFileParam _ r _ _) = r

addToSealedFileFromAttachmentDetailsWithFileIDOrFileParam :: AttachmentDetailsWithFileIDOrFileParam -> Bool
addToSealedFileFromAttachmentDetailsWithFileIDOrFileParam (AttachmentDetailsWithFileID _ _ a _) = a
addToSealedFileFromAttachmentDetailsWithFileIDOrFileParam (AttachmentDetailsWithFileParam _ _ a _) = a
...
toAttachmentDetails (AttachmentDetailsWithFileParam n r a fp)  = AttachmentDetails n r a (Right fp)
...
unjsonAttachmentDetails = invmap toAttachmentDetails fromAttachmentDetails $ unionOf [
    ($(isConstr 'AttachmentDetailsWithFileID), pure AttachmentDetailsWithFileID
      ...
      <*> field "add_to_sealed_file" addToSealedFileFromAttachmentDetailsWithFileIDOrFileParam "Should attachment be added to sealed pdf"
