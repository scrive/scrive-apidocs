...
documentAPIV2 = dir "documents" $ choice
  ...
  , (param . dir "files" . hGet . toK3)
    $ \docID fileID fname -> docApiV2FilesGet docID fileID (Just fname)
  , (param . dir "files" . hGet . toK2)
    $ \docID fileID -> docApiV2FilesGet docID fileID Nothing
