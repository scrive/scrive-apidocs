...
staticRoutes production = choice
  ...
  , (allLangDirs . dir "padqueue" . hGet . toK0) (return LinkPadList)
  ...
  -- These are actions on documents. We may integrate it with all the stuff
  -- above, but I don't like it. MR
  ...
  , (dir "preview" . hGet . toK3)
    $ \did slid fid -> DocControl.showPreviewForSignatory did slid Nothing fid
  , (dir "preview" . hGet . toK4)
    $ \did slid mh fid -> DocControl.showPreviewForSignatory did slid (Just mh) fid
