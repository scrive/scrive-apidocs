...
featureFlagsRenameDKNemIDToViewAndAddPIDAndCVRVersion :: MonadDB m => Migration m
featureFlagsRenameDKNemIDToViewAndAddPIDAndCVRVersion = Migration
  { mgrTableName = tblName tableFeatureFlags
  , mgrFrom      = 25
  , mgrAction    =
    StandardMigration $ do
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ "RENAME COLUMN can_use_dk_authentication_to_view TO can_use_dk_cpr_authentication_to_view"
        ]
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_dk_pid_authentication_to_view"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [sqlAlterColumn "can_use_dk_pid_authentication_to_view" "DROP DEFAULT"]
      runQuery_ . sqlUpdate "feature_flags" $ do
        sqlSetCmd "can_use_dk_pid_authentication_to_view"
                  "can_use_dk_cpr_authentication_to_view"
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_dk_cvr_authentication_to_view"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [sqlAlterColumn "can_use_dk_cvr_authentication_to_view" "DROP DEFAULT"]
      runQuery_ . sqlCreateComposite $ CompositeType
        ...
        , ctColumns =
          ...
          , CompositeColumn { ccName = "can_use_sms_invitations", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_sms_confirmations", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_dk_cpr_authentication_to_view"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_dk_pid_authentication_to_view"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_dk_cvr_authentication_to_view"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_dk_authentication_to_sign"
                            , ccType = BoolT
      ...
      runQuery_ $ sqlDropComposite "feature_flags_c8"
  }

featureFlagsAddVerimiQesToSign :: MonadDB m => Migration m
featureFlagsAddVerimiQesToSign = Migration
  { mgrTableName = tblName tableFeatureFlags
  , mgrFrom      = 26
  , mgrAction    =
    StandardMigration $ do
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_verimi_qes_to_sign"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [sqlAlterColumn "can_use_verimi_qes_to_sign" "DROP DEFAULT"]
      runQuery_ $ sqlDropComposite "feature_flags_c9"
      runQuery_ . sqlCreateComposite $ CompositeType
...
featureFlagsRenameNemIDCPRAndAddPIDAndCVRToSign :: MonadDB m => Migration m
featureFlagsRenameNemIDCPRAndAddPIDAndCVRToSign = Migration
  { mgrTableName = tblName tableFeatureFlags
  , mgrFrom      = 27
  , mgrAction    =
    StandardMigration $ do
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ "RENAME COLUMN can_use_dk_authentication_to_sign TO can_use_dk_cpr_authentication_to_sign"
        ]
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_dk_pid_authentication_to_sign"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [sqlAlterColumn "can_use_dk_pid_authentication_to_sign" "DROP DEFAULT"]
      runQuery_ . sqlUpdate "feature_flags" $ do
        sqlSetCmd "can_use_dk_pid_authentication_to_sign"
                  "can_use_dk_cpr_authentication_to_sign"
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_dk_cvr_authentication_to_sign"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [sqlAlterColumn "can_use_dk_cvr_authentication_to_sign" "DROP DEFAULT"]
      runQuery_ . sqlCreateComposite $ CompositeType
        ...
        , ctColumns =
          ...
          , CompositeColumn { ccName = "can_use_dk_cpr_authentication_to_sign"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_dk_pid_authentication_to_sign"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_dk_cvr_authentication_to_sign"
                            , ccType = BoolT
                            }
          , CompositeColumn { ccName = "can_use_fi_authentication_to_view"
                            , ccType = BoolT
      ...
      runQuery_ $ sqlDropComposite "feature_flags_c10"
  }

featureFlagsAddFlow :: MonadDB m => Migration m
featureFlagsAddFlow = Migration
  { mgrTableName = tblName tableFeatureFlags
  , mgrFrom      = 28
  , mgrAction    =
    StandardMigration $ do
      runQuery_ $ sqlAlterTable
        (tblName tableFeatureFlags)
        [ sqlAddColumn $ tblColumn { colName     = "can_use_flow"
                                   , colType     = BoolT
                                   , colNullable = False
                                   , colDefault  = Just "False"
                                   }
      ...
      runQuery_ $ sqlAlterTable (tblName tableFeatureFlags)
                                [sqlAlterColumn "can_use_flow" "DROP DEFAULT"]
      runQuery_ $ sqlDropComposite "feature_flags_c11"
      runQuery_ . sqlCreateComposite $ CompositeType
        { ctName    = "feature_flags_c13"
        , ctColumns =
          [ CompositeColumn { ccName = "can_use_templates", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_branding", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_author_attachments", ccType = BoolT }
          ...
          , CompositeColumn { ccName = "can_use_archive_to_share_point", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_archive_to_sftp", ccType = BoolT }
          , CompositeColumn { ccName = "can_use_flow", ccType = BoolT }
          ]
        }
  }
