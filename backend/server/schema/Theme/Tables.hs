...
tableThemes = tblTable
  ...
  , tblColumns    =
    ...
    , tblColumn { colName     = "brand_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "brand_text_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "action_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "action_text_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "action_secondary_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "action_secondary_text_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "positive_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "positive_text_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "negative_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
    , tblColumn { colName     = "negative_text_color"
                , colType     = CustomT "color"
                , colNullable = False
                }
...
domainFont = Domain
  ...
  , domNullable = False
  , domDefault  = Nothing
  , domChecks   = mkChecks [tblCheck { chkName = "font_in_set", chkCondition = sql }]
  }  where
    sql = rawSQL (T.intercalate " OR " $ map value fonts) ()
