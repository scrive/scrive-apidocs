...
kontraComposites = concat [otherComposites, userGroupComposites, mailerComposites]
  where
    otherComposites =
      [ ctAuthorAttachment
...
kontraTables :: [Table]
kontraTables = concat
  [kontraTables1, cronTables, mailerTables, messengerTables, kontraTables2, flowTables]
  where
    kontraTables1 =
      [ tableThemes
      , tableBrandedDomains
