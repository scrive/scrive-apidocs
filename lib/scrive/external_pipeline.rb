# Middleman's external_pipeline is not interpreting the frontmatter of the
# Markdown output as YAML.
# This is a modified version of the extension :external_pipeline to add the
# option frontmatter.

require 'middleman-core/extension'

class Middleman::Extensions::ScriveExternalPipeline < ::Middleman::Extension
  ...
  option :frontmatter, false, "Whether to parse the Markdown's frontmatter as YAML"
...
Middleman::Extensions.register :scrive_external_pipeline do
  Middleman::Extensions::ScriveExternalPipeline
end
