-- Fork from https://github.com/rundis/elm-bootstrap/blob/e412efe628854345d452489acd56ade0c732bad6/src/Bootstrap/Popover.elm
-- in order to expose State.isActive


module Vendor.Popover exposing
