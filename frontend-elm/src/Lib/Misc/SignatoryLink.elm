...
getPersonalNumberField =
  findSignatoryField
    (\field -> case field of
        SignatoryPersonalNumberField _ -> Just field
        _ -> Nothing
    )

getTextField : (SignatoryField -> Maybe String) -> SignatoryLink -> String
getTextField p = findSignatoryField p >> Maybe.withDefault ""

getPersonalNumber : SignatoryLink -> String
getPersonalNumber =
  getTextField
    (\field -> case field of
        SignatoryPersonalNumberField {value} -> Just value
        _ -> Nothing
    )
...
getEmail =
  getTextField
    (\field -> case field of
        SignatoryEmailField {value} -> Just value
        _ -> Nothing
    )
...
getMobileNumber =
  getTextField
    (\field -> case field of
        SignatoryMobileField {value} -> Just value
        _ -> Nothing
    )
