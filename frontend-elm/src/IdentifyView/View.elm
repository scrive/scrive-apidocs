...
import Html exposing (Html, a, b, div, h4, img, p, text, textarea)
                    ...
                    , div [ class "identify-box" ]
                        ...
                        , div [ class "identify-box-footer" ]
                            [ div [ class "identify-box-footer-text" ]
                                ...
                                , case innerModel of
                                    IdentifySMSPin params _ ->
                                        SMSPin.viewFooter params

                                    IdentifyGenericEidService params _ ->
                                        GenericEidService.viewFooter params

                                    IdentifyRejection params _ ->
                                        Rejection.viewFooter params
                                ]
                            , div [ class "identify-box-footer-logo" ]
                                [ case innerModel of
                                    ...
                                    IdentifyGenericEidService params _ ->
                                        GenericEidService.viewLogo params

                                    IdentifyRejection _ _ ->
                                        div [] []
                                ]
                            ]
                        ]
