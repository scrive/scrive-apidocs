...
let
  sources = {
    ...
    "autoprefixer-9.7.1" = {
      ...
      version = "9.7.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/autoprefixer/-/autoprefixer-9.7.1.tgz";
        sha512 = "w3b5y1PXWlhYulevrTJ0lizkQ5CyqfeU6BIRDbuhsMupstHQOeb1Ur80tcB1zxSu7AwyY/qCQ7Vvqklh31ZBFw==";
      };
    };
    "aws-sign2-0.7.0" = {
      name = "aws-sign2";
